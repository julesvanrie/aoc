...
if part == 2:
    for line in risk_levels:
        extensions = []
        for i in range(1,5):
            extension = [d + i if d + i < 10 else d + i - 9 for d in line]
            extensions.extend(extension)
        line.extend(extensions)

    extensions = []
    for i in range(1, 5):
        extension = [[d + i if d + i < 10 else d + i - 9 for d in line] for line in risk_levels]
        extensions.extend(extension)
    risk_levels.extend(extensions)
